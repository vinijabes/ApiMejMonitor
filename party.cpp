...
bool Party::join(Player* player)
{
	...
	sprintf(buffer, "You have joined %s'%s party. Open the party channel to communicate with your companions.\n(!party)", leader->getName().c_str(), (leader->getName()[leader->getName().length() - 1] == 's' ? "" : "s"));
...
void Party::updateSharedExperience()
{
	...
	/*char buffer[150];
	sprintf(buffer,"*Bonus Party: Actived!");
	broadcastMessage(MSG_PARTY, buffer);*/
